...
(let* ((bg "#121317")
      ...
      (on-primary "#003063")
      (on-primary-container "#001431")
      (on-secondary "#253146")
      (on-secondary-container "#acb9d3")
      (on-surface "#e2e2e7")
      (on-surface-variant "#c3c6d1")
      (on-tertiary "#4b1e50")
      (on-tertiary-container "#2a0032")
      (outline-color "#8d909a")
      (outline-variant "#43474f")
      (primary "#a9c7ff")
      (primary-container "#7091cc")
      (secondary "#bac7e2")
      (secondary-container "#3d4960")
      (shadow "#000000")
      (surface "#121317")
      ...
      (tertiary "#efb3f0")
      (tertiary-container "#b57eb7")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#efb3f0")
      (on-success "#4b1e50")
      (success-container "#b57eb7")
      (on-success-container "#2a0032")
      ;; Map fixed colors to regular colors
      (primary-fixed "#a9c7ff")
      (primary-fixed-dim "#7091cc")
      (secondary-fixed "#bac7e2")
      (secondary-fixed-dim "#3d4960")
      (tertiary-fixed "#efb3f0")
      (tertiary-fixed-dim "#b57eb7")
      (on-primary-fixed "#003063")
      (on-primary-fixed-variant "#001431")
      (on-secondary-fixed "#253146")
      (on-secondary-fixed-variant "#acb9d3")
      (on-tertiary-fixed "#4b1e50")
      (on-tertiary-fixed-variant "#2a0032")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#e2e2e7")
      (inverse-primary "#a9c7ff")
      (inverse-surface "#121317")
