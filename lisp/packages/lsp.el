...
;; Supports PHP, TypeScript, JavaScript, HTML, CSS, and C.
...
(use-package lsp-mode
  ...
  :hook (;; Languages
         ...
         (html-mode . lsp)
         (css-mode . lsp)
         (c-mode . lsp) ;; For your ashwc compositor project
...
;; Enhanced UI elements (peek, doc, etc.)
(use-package lsp-ui
  :ensure t
...
;; Optional: Flycheck for better error highlighting than Flymake
